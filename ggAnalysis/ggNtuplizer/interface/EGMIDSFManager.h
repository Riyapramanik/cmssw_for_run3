...
public:
    ...
    double getElectronIDSFUncUp(const std::string& idType, double pt, double eta, double phi);
    double getElectronIDSFUncDown(const std::string& idType, double pt, double eta, double phi);
